...
RPCClient.REQUEST = 0;
RPCClient.RESPONSE = 1;
RPCClient.NOTIFY = 2;
RPCClient.REQUEST_STREAM_CHUNCK = 3;
RPCClient.RESPONSE_STREAM_CHUNCK = 4;
RPCClient.REQUEST_STREAM_END = 5;
RPCClient.RESPONSE_STREAM_END = 6;
RPCClient.REQUEST_CANCEL = 7;
RPCClient.RESPONSE_CANCEL = 8;

module.exports = {StopIteration:StopIteration, Queue:Queue, RPCClient:RPCClient};